...
const nameGreeting = nameCheck("Max");
console.log(nameGreeting); // Cool name, Max
...
//CODE HERE
function theEliminator(params1, params2) {
  for (let i = 0; i < params1.length; i++) {
    const element = params1[i];
    if (element === params2) {
...
function emailCheck(email) {
  let emailCheck = email.toString().trim().split("");
...
console.log(emailCheck("hello@hello.com"));
console.log(emailCheck("hello.com"));
...
//CODE HERE
function chocoFrog(gold) {
  let frogCost = 3;
  let totalFrogs = Math.floor(gold / frogCost);
  return totalFrogs;
}

const totalFrogs = chocoFrog(10);
...
let arrayIsAscending = isArrayAsc(sampleArray);
